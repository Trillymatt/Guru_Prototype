...
export default function ScheduleStep({
    ...
    title = 'When & where?',
    subtitle = 'Pick your preferred date. We will confirm the exact time when your parts arrive.',
    nextLabel = 'Review & Book →',
    showNextButton = true,
}) {
    ...
    return (
        <div className="quiz__panel animate-fade-in-up">
            ...
            <p className="quiz__subtitle">{subtitle}</p>
            ...
            {showDateSection && scheduleDate && availableDates && !availableDates.has(scheduleDate) && (
            ...
            <div className="quiz__actions">
                ...
                {showNextButton && (
                    <button
                        ...
                        disabled={
                            (showAddressSection && (!scheduleAddress || Boolean(serviceAreaError))) ||
                            (showDateSection && !scheduleDate)
                        }
                        onClick={onNext}
                    >
                        {nextLabel}
